...
namespace LamaLama\Productive\Endpoints;

use LamaLama\Productive\Exceptions\ApiException;
use LamaLama\Productive\Resources\Task;
use LamaLama\Productive\Resources\TaskCollection;
...
class TasksEndpoint
{
    ...
    {
        return new TaskCollection($this->client, $count, $_links);
    }
    ...
    /**
     * Retrieve a single payment from Productive.
     *
     * Will throw a ApiException if the payment id is invalid or the resource cannot be found.
     *
     * @param string $paymentId
